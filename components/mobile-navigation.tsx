...
export function MobileNavigation() {
    ...
    return(
        ...
        <div className="flex items-center justify-around py-2">
          ...
          <Button variant="ghost" size="icon" className="text-gray-400" onClick={()=>router.push("/tripeasy")}>
            <Search className="w-6 h-6" />
          </Button>
          <Button variant="ghost" size="icon" className="text-gray-400" onClick={()=>router.push("/person/me?form=create")}>
            <PlusSquare className="w-6 h-6" />
          </Button>
          <Button variant="ghost" size="icon" className="text-gray-400" onClick={()=>router.push("/person/likes")}>
